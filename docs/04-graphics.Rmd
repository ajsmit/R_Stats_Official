...
> **Exercise 1** Choose the *Ecklonia* dataset and create four distinctly different figures arranged neatly as four panels using **ggbubr**'s `ggarrange()`. Examples of different graphs to use can be seen earlier in this chapter.
