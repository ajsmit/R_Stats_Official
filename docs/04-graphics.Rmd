...
```{r graphics-plot3, fig.cap="Panelled grouped histograms for the four Iris variables."}
...
```{r graphics-plot4a, fig.margin = TRUE, fig.cap="Examples of box plots made for the Iris data. A) A default box plot for one of the variables only. B) A panelled collection of box plots, one for each of the four variables, with a scatterplot to indicate the spread of the actual replicates." }
...
```{r graphics-plot4b, fig.margin = TRUE, fig.cap="Examples of violin plots made for the Iris data." }
# for reproducibility
library(ggstatsplot)
set.seed(123)
...
```{r graphics-plot5, fig.margin = TRUE, fig.height = 3, fig.width = 6, fig.cap="Examples of scatterplots made for the Iris data. A) A default scatter plot showing the relationship between petal length and width. B) The same as (A) but with a correlation line added."}
...
```{r graphics-plot6, fig.margin = TRUE, fig.cap="Box plots of the mean ± SD of the four Iris variables."}
...
```{r graphics-plot7, fig.cap="A bevy of density graphs option based on the iris data. A) A lone density graph. B) A density graph accompanied by a rug plot. C) A histogram with a density graph overlay. D) A ridge plot."}
...
```{r graphics-plot8, fig.cap="Variations of violin plots."}
# A basic violin plot
...
> **Exercise 1:** Choose the *Ecklonia* dataset and create four distinctly different figures arranged neatly as four panels using **ggpubr**'s `ggarrange()`. Examples of different graphs to use can be seen earlier in this chapter.
