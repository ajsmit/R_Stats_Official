...
We say in the ANOVA chapter how we could add a categorical variable to a regression -- or rather, we saw how we could had a continuous co-variate to an ANOVA. Whichever way we look at it, the analysis is the same. This is called an Analysis of Covariance, or ANCOVA.
...
>
> **Hint:** One can apply the `plot()` function to the regression model onject, or there are some functions in the **gg_diagnose** package. In fact, there are many, many ways of doing it.
