---
title: "Descriptive statistics: central tendency and dispersion"
author: "AJ Smit"
date: "`r Sys.Date()`"
output:
...
<img src="Resources/Standard_deviation_diagram.png" alt="Normal distribution" class="center" width="50%"/>
...
```{r descriptive-plot1, fig.cap = "The figures represent A) a scatterplot of the mean and raw chicken mass values; B) a bar graph of the chicken mass values, showing whiskers indicating 1 ±SD; C) a box and whisker plot of the chicken mass data; and D) chicken mass as a function of both `Diet` and `Time` (10 and 21 days)."}
